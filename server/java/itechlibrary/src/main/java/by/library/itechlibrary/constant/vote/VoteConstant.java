...
public final class VoteConstant {
    ...
    private static final VoteType POSITIVE_VOTE_TYPE = new VoteType((short) 1, VOTE_TYPE_POSITIVE_NAME);
    private static final VoteType NEGATIVE_VOTE_TYPE = new VoteType((short) 2, VOTE_TYPE_NEGATIVE_NAME);
