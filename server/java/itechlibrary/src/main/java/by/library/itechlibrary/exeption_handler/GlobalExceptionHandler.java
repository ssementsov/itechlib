...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<IncorrectData> handleException(WrongBookingStatusException exception) {
    ...
    @ExceptionHandler(BookingBookLimitException.class)
    public ResponseEntity<IncorrectData> handleException(BookingBookLimitException exception) {
    ...
    @ExceptionHandler(PaginationSortDirectionException.class)
    public ResponseEntity<IncorrectData> handleException(PaginationSortDirectionException exception) {
    ...
    @ExceptionHandler(NotFoundSuggestedBookVoteCounterException.class)
    public ResponseEntity<IncorrectData> handleException(NotFoundSuggestedBookVoteCounterException exception) {
